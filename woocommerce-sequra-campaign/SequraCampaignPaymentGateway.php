...
class SequraCampaignPaymentGateway extends WC_Payment_Gateway {
	...
	public static $BUCKET = 'https://s3-eu-west-1.amazonaws.com/shop-assets.sequrapi.com/';
	...
	function init_form_fields() {
		...
		$this->form_fields = array(
			...
			'title'    => array(
				...
				'type'        => 'text',
				'description' => __( 'This controls the title which the user sees during checkout.', 'wc_sequracampaign' ),
	...
	public
	static function template_loader(
		$template
	) {
