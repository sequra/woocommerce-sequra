...
abstract class Configure_Sequra_Entities_Task extends Task {
	...
	protected function set_widget_settings( bool $display_widgets, string $version = self::BLOCKS ): void {
		...
		$sp1_location_selector              = 'form.cart';
