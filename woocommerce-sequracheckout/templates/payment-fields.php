...
<div id="sq_pm_<?php echo esc_html( $sq_product_campaign );?>" class="sq_payment_method <?php echo esc_html( $sq_product_campaign ); ?>">
	<input type="radio" name="sq_product_campaign" value="<?php echo esc_html( $sq_product_campaign );?>" id="sq_product_campaign_<?php echo esc_html( $sq_product_campaign );?>" class="input-radio sq-input-radio"/>
